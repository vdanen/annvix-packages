...
Patch1:		pdns-2.9.17-avoid-version.diff.bz2
...
%configure2_5x \
    ...
    --with-modules="" \
    --with-mysql=%{_prefix} --with-mysql-lib=%{_libdir} --with-mysql-includes=%{_includedir}/mysql \
    --with-pgsql=%{_prefix} --with-pgsql-lib=%{_libdir} --with-pgsql-includes=%{_includedir}/pgsql\
    --enable-recursor
