#
# spec file for package php-hash
#
...
%define inifile		54_%{modname}.ini

Summary:	The hash module for PHP
Name:		%{name}
Version:	%{version}
Release:	%{release}
License:	PHP License
...
a native implementation of common message digest algorithms using a
