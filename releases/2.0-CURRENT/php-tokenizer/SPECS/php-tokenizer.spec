#
# spec file for package php-tokenizer
#
...
%define modname		tokenizer
%define dirname		%{modname}
%define soname		%{modname}.so
%define inifile		60_%{modname}.ini

Summary:	The tokenizer module for PHP
Name:		%{name}
Version:	%{version}
Release:	%{release}
License:	PHP License
...
mkdir -p ext
cp -rp %{phpsource}/ext/session ext/
