#
# spec file for package php-shmop
#
...
%define modname		shmop
%define dirname		%{modname}
%define soname		%{modname}.so
%define inifile		48_%{modname}.ini

Summary:	The shared memory operations module for PHP
Name:		%{name}
Version:	%{version}
Release:	%{release}
License:	PHP License
...
BuildRequires:  php-devel >= %{phpvesion}
