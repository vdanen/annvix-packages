#
# spec file for package php-sockets
#
...
%define modname		sockets
%define dirname		%{modname}
%define soname		%{modname}.so
%define inifile		52_%{modname}.ini

Summary:	The sockets module for PHP
Name:		%{name}
Version:	%{version}
Release:	%{release}
License:	PHP License
...
%description
This is a dynamic shared object (DSO) for PHP that will add socket
support.
