...
Patch0:		findutils-4.2.31-mdv-no-locate.patch
...
pattern).   The xargs utility builds and executes command lines from
...
%changelog
* Wed Nov 14 2007 Vincent Danen <vdanen-at-build.annvix.org> 4.2.31
- 4.2.31
