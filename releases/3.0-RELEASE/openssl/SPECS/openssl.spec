...
* Sat Oct 14 2006 Vincent Danen <vdanen-at-build.annvix.org> 0.9.8d
- 0.9.8d (security fixes for CVE-2006-2937, CVE-2006-2940, CVE-2006-3738,
  CVE-2006-4343)
- drop P15; fixed upstream
- drop P14; no longer required

* Wed Sep 05 2006 Vincent Danen <vdanen-at-build.annvix.org> 0.9.8b
- P15: security fix for CVE-2006-4339 (we'll upgrade to the latest later)

* Sat Aug 12 2006 Vincent Danen <vdanen-at-build.annvix.org> 0.9.8b
