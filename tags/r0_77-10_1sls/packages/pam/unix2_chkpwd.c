...
static int
_authenticate(const char *service, const char *user, const char *password)
{
	struct pam_conv conv = { _converse, (void *) password };
	pam_handle_t	*pamh;
	int		err;
...
main(int argc, char *argv[])
{
	...
	return _authenticate(service, user, pass);
}
